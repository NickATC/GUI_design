...
main_notebook.pack(expand = 1, fill = "both", padx = 30, pady = 30)  
...
#A button on window, visible no matter what notebook/tab I'm using
only_button = ttk.Button(window, text = "I'm outside the NoteBook!")
